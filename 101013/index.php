...
class pg_101013_index extends page_front
{
	...
	protected function view(){
		...
		$_SESSION["101013_NNSI_HEADER"] = serialize($nnsi_header);
		...
		$_SESSION["101013_SEARCH_HEADER"] = serialize($search_array);
	}
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '101/013.tpl.php');
	}
}

$page = new pg_101013_index();
$page->run();