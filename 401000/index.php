...
class pg_401000_index extends page_front
{
	...
	protected function view(){
        ...
        $this->_def_data['KOUJO'] = "";
        $this->_def_data['TC'] = "";
        $this->_def_data['OROSHI'] = "";
	...
	protected function render(){
		parent::render();
		$this->template->render(TEMPLATE_DIR. DS . '401/000.tpl.php');
	}
}

$page = new pg_401000_index();
$page->run();