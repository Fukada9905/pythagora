...
class pg_103030_index extends page_front
{
    private $_data = array();
    private $_selections;
	...
	protected function view(){
        ...
        $recent_date = $this->pdo->getRecentDates(2,$this->_selections,$this->user_info->user_id);
		...
		$_SESSION["103030_SEARCH_HEADER"] = serialize($search_array);
	}
	protected function render(){
		parent::render();
        $this->template->selections = $this->_selections;
		$this->template->data = $this->_data;
		$this->template->render(TEMPLATE_DIR. DS . '103/030.tpl.php');
	}
}

$page = new pg_103030_index();
$page->run();