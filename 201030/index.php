...
class pg_201030_index extends page_front
{
	...
	protected function view(){
		...
		$_SESSION["201030_SEARCH_HEADER"] = serialize($search_array);
	...
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '201/030.tpl.php');
	}
}

$page = new pg_201030_index();
$page->run();