...
class pg_101042_index extends page_front
{
    private $_selections;
	...
	protected function view(){
		...
		$_SESSION["101042_NNSI_HEADER"] = serialize($nnsi_header);
		...
		$_SESSION["101042_SEARCH_HEADER"] = serialize($search_array);
	...
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '101/042.tpl.php');
	}
}

$page = new pg_101042_index();
$page->run();