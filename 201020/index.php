...
class pg_201020_index extends page_front
{
	...
	protected function view(){
		...
		$_SESSION["201020_SEARCH_HEADER"] = serialize($search_array);
	}
	protected function render(){
		parent::render();
		//$this->template->recent_date = $this->_recent_date;
		$this->template->date_conditions = $this->_date_conditions;
		$this->template->render(TEMPLATE_DIR. DS . '201/020.tpl.php');
	}
}

$page = new pg_201020_index();
$page->run();