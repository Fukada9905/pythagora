...
class pg_101015_index extends page_front
{
	...
	protected function view(){
		...
		$_SESSION["101015_SEARCH_HEADER"] = serialize($search_array);
	...
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '101/015.tpl.php');
	}
}

$page = new pg_101015_index();
$page->run();