...
class pg_101041_index extends page_front
{
    private $_selections;
	...
	protected function view(){
		...
		if($_SESSION["101040_NINUSHI"]){
            $data = array();
            foreach ($_SESSION["101040_NINUSHI"] as $row){
		...
		$_SESSION["101041_NNSI_HEADER"] = serialize($nnsi_header);
		...
		$_SESSION["101041_SEARCH_HEADER"] = serialize($search_array);
	...
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '101/041.tpl.php');
	}
}

$page = new pg_101041_index();
$page->run();