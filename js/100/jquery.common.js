$(document).ready(function(){
	...
	sessionStorage.setItem(LS_PROCESS_DIVIDE,1);
});
...
function SetJigyoshoToStorage(){
	...
	var params = {
		'100000_JGSCD':JSON.parse(sessionStorage.getItem(LS_JIGYOSHO))
	,	'100000_PTNCD':JSON.parse(sessionStorage.getItem(LS_PARTNER))
	};
