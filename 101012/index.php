...
class pg_101012_index extends page_front
{
	...
	protected function view(){
		...
		$_SESSION["101012_NNSI_HEADER"] = serialize($nnsi_header);
		...
		$_SESSION["101012_SEARCH_HEADER"] = serialize($search_array);
	...
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '101/012.tpl.php');
	}
}

$page = new pg_101012_index();
$page->run();