...
class pg_101045_index extends page_front
{
    private $_selections;
	...
	protected function view(){
		...
		$_SESSION["101045_SEARCH_HEADER"] = serialize($search_array);
	...
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '101/045.tpl.php');
	}
}

$page = new pg_101045_index();
$page->run();