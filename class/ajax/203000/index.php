<?php
class ajax_203000_index extends ajax_base{
		...
		try{
			switch($this->process_divide){
				...
				case "get_detail_data":
					$this->GetDetailData($data["ids"]);
					break;
				case "update_data":
					$this->UpdateData($data["Update_data"],$data["Reporter"]);
					break;
				case "cancel_data":
	...
	private function GetDetailData($ids){
	...
	private function UpdateData($update_data,$reporter){
