...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    */
     ...
     * @return array
     */
	public function rangeToArray($pRange = 'A1', $nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false, $left_space = 0, $right_space = 0) {
        // Returnvalue
        $returnValue = array();
        ...
        for ($row = $minRow; $row <= $maxRow; ++$row) {
            ...
            for ($col = $minCol; $col != $maxCol; ++$col) {
                $c++;
                $cRef = ($returnCellRef) ? $col : $col_num;
            ...
            if(!$returnCellRef){
                for($i = 0;$i<$right_space;$i++){
                    unset($returnValue[$rRef][count($returnValue[$rRef])-1]);
                }
            }
        }
     ...
     * @return array
     */
	public function toArray($nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false,$left_space = 0,$right_space = 0) {
        // Garbage collect...
        $this->garbageCollect();
		...
		return $this->rangeToArray(	'A1:'.$maxCol.$maxRow,
									$nullValue, $calculateFormulas, $formatData, $returnCellRef,$left_space,$right_space);
    }
	...
	public function garbageCollect() {
        ...
        // Build a reference table from jquery_ui
