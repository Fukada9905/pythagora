...
class pdf_101013_index extends pdf_common{
	...
	public function DoInit()
	{
		...
		$this->seach_conditions = unserialize($_SESSION["101013_SEARCH_HEADER"]);
		...
		$this->def_y = 14;
		$this->nnsi_headers = unserialize($_SESSION["101013_NNSI_HEADER"]);
