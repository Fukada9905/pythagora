...
class pdf_101041_index extends pdf_common{
	...
	public function DoInit()
	{
		...
		$this->def_y = 14;
		$this->nnsi_headers = unserialize($_SESSION["101041_NNSI_HEADER"]);
	...
	private function DrawConditionHeader(){
		...
		$seach_conditions = unserialize($_SESSION["101011_SEARCH_HEADER"]);
		$y = $this->def_y;
