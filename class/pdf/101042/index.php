...
class pdf_101042_index extends pdf_common{
	...
	public function DoInit()
	{
		...
		$this->def_y = 14;
		$this->nnsi_headers = unserialize($_SESSION["101042_NNSI_HEADER"]);
	...
	private function DrawConditionHeader(){
		...
		$seach_conditions = unserialize($_SESSION["101042_SEARCH_HEADER"]);
		$y = $this->def_y;
		foreach ($seach_conditions as $key => $val){
			$cell_params = array(
				"x" => $this->def_x
			,   "y" => $y
			,   "w" => 15
