...
class pdf_101012_index extends pdf_common{
	...
	public function DoInit()
	{
		...
		$this->def_y = 14;
		$this->nnsi_headers = unserialize($_SESSION["101012_NNSI_HEADER"]);
	...
	private function DrawConditionHeader(){
		...
		$seach_conditions = unserialize($_SESSION["101012_SEARCH_HEADER"]);
		$y = $this->def_y;
