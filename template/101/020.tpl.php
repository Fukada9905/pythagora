...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_header.tpl.php"); ?>
    ...
    <article>
			...
			<section class="input_area">
				...
				<div class="input_area_wrapper">
					...
					<dl class="input_area_inner">
						<dt>パートナー</dt>
						<dd>
							<button type="button" class="btn btn_function" data-open-target="partner" data-is-noset="true"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>パートナー指定</button>
        ...
        <section id="top_navigation" class="box_container">
            <ul>
                <li><a href="#" class="hover_txt function_menu btn_print" data-target-process-divide="1"><div class="img_wrap"><img src="<?=IMG_DIR?>/icon/ver201911/icon19.png" alt="フロア別ピッキングリスト"></div>フロア別ピッキングリスト</a></li>
				<li><a href="#" class="hover_txt function_menu btn_print" data-target-process-divide="2"><div class="img_wrap"><img src="<?=IMG_DIR?>/icon/ver201911/icon02.png" alt="業者別ピッキングリスト"></div>業者別ピッキングリスト</a></li>
				<li><a href="#" class="hover_txt function_menu btn_print" data-target-process-divide="3"><div class="img_wrap"><img src="<?=IMG_DIR?>/icon/ver201911/icon18.png" alt="店別ピッキングリスト"></div>店別ピッキングリスト</a></li>
            </ul>
        </section>
...
<script src="<?=JS_DIR?>/101/jquery.020.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
