...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_header.tpl.php"); ?>
    ...
    <article>
        ...
        <section id="over_btn" class="submit_btns">
            <div>
                <button type="button" class="btn btn_output btn_output_page1">出荷倉庫別</button>
                <?php if(!$is_partner && !$is_partner_select) :?>
                <button type="button" class="btn btn_output btn_output_page2">運送業者別</button>
                <button type="button" class="btn btn_output btn_output_page3">TC幹線</button>
                <?php else :?>
                <button type="button" class="btn btn_output btn_output_page4">メーカー別</button>
                <button type="button" class="btn btn_output btn_output_page5">納品先別</button>
                <?php endif;?>
            </div>
        </section>
            ...
            <div class="table_wrap">
                <table id="data_table" class="list_table">
                    ...
                    <tr>
                        ...
                        <th><span id="dateymd_title"><?=$def_data['DATEYMD_TITLE'];?></span><div class="sort_btn" data-target-trigger="DATEYMD" data-sort-order="DESC"><i class="fa fa-caret-down" aria-hidden="true"></i></div></th>
                        <th>事業所<div class="sort_btn" data-target-trigger="JGSCD" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
                        <th>運送会社<div class="sort_btn" data-target-trigger="PTNCD" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_overray.tpl.php"); ?>
    ...
    <script src="<?=JS_DIR?>/101/jquery.040.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
