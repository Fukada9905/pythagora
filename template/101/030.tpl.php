    ...
    <article>
		...
		<section class="box_container data_area">
			<div class="table_wrap">
				<table id="data_table" class="list_table">
					<thead>
						<tr>
                            <th>処理日<div class="sort_btn on_sort" data-target-trigger="SYORIYMD" data-sort-order="DESC"><i class="fa fa-caret-down" aria-hidden="true"></i></div></th>
							...
							<th>事業所名<div class="sort_btn" data-target-trigger="JGSCD" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
							<th class="pt_name_col">業者名<div class="sort_btn" data-target-trigger="PTNCD" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
		...
		<section class="hidden_data">
			<form name="output_form">
				...
				<input type="hidden" id="param_process_divide" name="process_divide" value="<?=$process_divide?>">
...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_overray.tpl.php"); ?>
    ...
    <script src="<?=JS_DIR?>/101/jquery.030.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
