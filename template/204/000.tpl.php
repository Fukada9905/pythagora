		...
		<section class="box_container data_area">
			<div class="table_wrap">
				<table id="data_table" class="list_table">
					<thead>
					<tr>
						<th>報告日時<div class="sort_btn on_sort" data-target-trigger="ReportDatetime" data-sort-order="DESC"><i class="fa fa-caret-down" aria-hidden="true"></i></div></th>
...
<div id="over_ray_tables">
	...
	<div class="over_ray_inner">
		...
		<div class="over_ray_footers_multi clearfix">
			...
			<button type="button" class="btn btn_send input_controls" data-target-id="" disabled>送信</button>
		</div>
	</div>
</div>
    <script src="<?=JS_DIR?>/200/jquery.common.js?ver=<?=date('ymdHis')?>"></script>
    <script src="<?=JS_DIR?>/204/jquery.000.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
