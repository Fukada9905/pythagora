    ...
    <article>
        ...
        <section id="over_btn" class="submit_btns">
            <div>
                ...
                <button type="button" class="btn btn_output btn_output_page1">集計</button>
                <?php else :?>
                <button type="button" class="btn btn_output btn_output_page2">集計</button>
                <?php endif;?>
            </div>
        </section>
        ...
        <section class="hidden_data">
            <p id="process_divide_text"><?=(!$is_partner && !$is_partner_select) ? "1" : "2" ?></p>
...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_overray.tpl.php"); ?>
    ...
    <script src="<?=JS_DIR?>/103/jquery.040.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
