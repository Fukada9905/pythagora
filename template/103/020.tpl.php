...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_header.tpl.php"); ?>
    ...
    <article>
					...
					<div class="input_area_wrapper">
						...
						<?php if(!$is_partner && !$is_partner_select) : ?>
							<dl class="input_area_inner">
								<dt>PT名称</dt>
								<dd>
									<label><input type="radio" name="pt_divide" value="1" class="input_controls focus_controls" data-default-value="" data-focus-group="header_input">有</label
									<label><input type="radio" name="pt_divide" value="2" class="input_controls focus_controls" data-default-value="checked" data-focus-group="header_input">無</label>
								</dd>
							</dl>
						<?php endif;?>
					</div>
		...
		<section id="over_btn" class="submit_btns">
			<div>
				<button type="button" class="btn btn_output btn_output_pdf1"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>業者別</button>
				<button type="button" class="btn btn_output btn_output_pdf2"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>倉庫別</button>
		...
		<section class="box_container data_area">
			<div class="table_wrap">
				<table id="data_table" class="list_table">
					<thead>
						<tr>
                            <th class="date_divide_col">処理日<div class="sort_btn on_sort" data-target-trigger="SYORIYMD" data-sort-order="DESC"><i class="fa fa-caret-down" aria-hidden="true"></i></div></th>
                            <th class="date_divide_col"><span>出荷日</span><div class="sort_btn" data-target-trigger="DATEYMD" data-sort-order="DESC"><i class="fa fa-caret-down" aria-hidden="true"></i></div></th>
							<th>倉庫名称<div class="sort_btn" data-target-trigger="SNTCD" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
							<th>運送業者<div class="sort_btn" data-target-trigger="UNSKSCD" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
		...
		<section class="hidden_data">
			<form name="output_form_csv">
				...
				<input type="hidden" id="param_pt_divide" name="pt_name_divide" value="1">
			</form>
...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_overray.tpl.php"); ?>
    ...
    <script src="<?=JS_DIR?>/103/jquery.020.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
