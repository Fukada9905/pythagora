			...
			<div class="table_wrap">
				<table id="data_table" class="list_table">
					...
					<tr>
						...
						<th>差戻<div class="sort_btn" data-target-trigger="HasReturn" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
						<th>確認<div class="sort_btn" data-target-trigger="Status" data-sort-order="DESC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
						<th>&nbsp;</th>
					</tr>
					</thead>
					<tbody>
					<td colspan="7" class="no_data">対象データがありません</td>
					</tbody>
				</table>
			</div>
		</section>
...
<div id="over_ray_tables">
	...
	<div class="over_ray_inner">
		...
		<div class="over_ray_footers">
			...
			<button type="button" class="btn btn_send input_controls" data-target-id="">送信</button>
		</div>
	</div>
</div>
<script src="<?=JS_DIR?>/300/jquery.common.js?ver=<?=date('ymdHis')?>"></script>
<script src="<?=JS_DIR?>/302/jquery.000.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
