    ...
    <article>
				...
				<form id="status_input_area">
					<div class="input_area_wrapper">
                        ...
                        <dl class="input_area_inner">
                            <dt>運送形態</dt>
                            <dd>
                                <label><input type="radio" name="get_divide" value="1" class="input_controls focus_controls" data-default-value="<?=$def_data['HOKYU'];?>" <?=$def_data['HOKYU'];?> data-focus-group="header_input">補給</label>
                                <label><input type="radio" name="get_divide" value="2" class="input_controls focus_controls" data-default-value="<?=$def_data['KOUJO'];?>" <?=$def_data['KOUJO'];?> data-focus-group="header_input">工場直送</label>
                                <label><input type="radio" name="get_divide" value="3" class="input_controls focus_controls" data-default-value="<?=$def_data['TC'];?>" <?=$def_data['TC'];?> data-focus-group="header_input">TC幹線</label>
                                <label><input type="radio" name="get_divide" value="4" class="input_controls focus_controls" data-default-value="<?=$def_data['OROSHI'];?>" <?=$def_data['OROSHI'];?> data-focus-group="header_input">卸配送</label>
                            </dd>
                        </dl>
                        ...
                        <dl class="input_area_inner not_master">
                            <dt>積地倉庫</dt>
                            <dd>
                                <button type="button" class="btn btn_function" data-open-target="center" data-is-noset="true"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>積地センター指定</button>
                        ...
                        <dl class="input_area_inner only_master">
                            <dt>積地倉庫</dt>
                            <dd>
                                <button type="button" class="btn btn_function" data-open-target="root_partner1" data-is-noset="true"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>積地センター指定</button>
                                <div id="selection_ROOTPT1_text" class="selection_text">指定なし</div>
                            </dd>
                        </dl>
                        <dl class="input_area_inner not_master">
                            <dt>納品先</dt>
                            <dd>
                                <button type="button" class="btn btn_function_other btn_nohin_select"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>納品先指定</button>
                                <div id="selection_NOHIN_text" class="selection_text">指定なし</div>
                            </dd>
                        </dl>
                        <dl class="input_area_inner only_master">
                            <dt>納品先</dt>
                            <dd>
                                <button type="button" class="btn btn_function" data-open-target="root_partner2" data-is-noset="true"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>納品先指定</button>
                                <div id="selection_ROOTPT2_text" class="selection_text">指定なし</div>
                            </dd>
                        </dl>
        ...
        <section id="over_btn" class="submit_btns">
            <div>
                ...
                <button type="button" class="btn btn_output btn_entry">車番入力</button>
            </div>
        </section>
		...
		<section class="hidden_data">
			...
			<form name="output_form_pdf">
                ...
                <input type="hidden" id="get_divide" name="get_divide" value="">
			</form>
		</section>
	...
	<div class="over_ray_inner">
		...
		<div class="over_ray_footers_multi clearfix">
			...
			<div class="footer_inner">
				<dl>
					<dt>配車担当者(姓)</dt>
					<dd><input type="text" name="Dispatcher" id="Dispatcher" class="y_hatch" value="" maxlength="10"></dd>
				</dl>
				<button type="button" class="btn btn_send input_controls" data-work_id="" disabled>登録</button>
			</div>
		</div>
	</div>
</div>
<script src="<?=JS_DIR?>/400/jquery.common.js?ver=<?=date('ymdHis')?>"></script>
<script src="<?=JS_DIR?>/401/jquery.000.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
