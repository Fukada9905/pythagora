				...
				<table id="data_table" class="list_table">
					<thead>
						<tr>
                            ...
                            <th>納品日<div class="sort_btn" data-target-trigger="NOHINYMD" data-sort-order="DESC"><i class="fa fa-caret-down" aria-hidden="true"></i></div></th>
                            ...
                            <th>センター<div class="sort_btn" data-target-trigger="SNTCD" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
                            <th>出荷場所<div class="sort_btn" data-target-trigger="SYUKAP" data-sort-order="ASC"><i class="fa fa-caret-up" aria-hidden="true"></i></div></th>
...
<?php require_once(TEMPLATE_DIR . DS . "common_parts/contents_overray.tpl.php"); ?>
    ...
    <script src="<?=JS_DIR?>/105/jquery.000.js?ver=<?=date('ymdHis')?>"></script>
</body>
</html>
