DROP TABLE IF EXISTS pyt_t_shaban_details_history;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_t_shaban_details_history(
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='pythagora用車番明細テーブルの履歴保持を行う';//
