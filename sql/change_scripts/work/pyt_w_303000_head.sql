DROP TABLE IF EXISTS pyt_w_303000_head;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_303000_head(
...
,	KEY IX_pyt_w_303000_head_user_id (user_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='棚卸承認一時テーブル (棚卸承認一時テーブル(ヘッダー))';//
