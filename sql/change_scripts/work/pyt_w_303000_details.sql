DROP TABLE IF EXISTS pyt_w_303000_details;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_303000_details(
...
,	KEY IX_pyt_w_303000_details_work_id (work_id, user_id)
,	CONSTRAINT FK_pyt_w_303000_details_pyt_w_303000_head
		FOREIGN KEY (work_id, user_id) REFERENCES pyt_w_303000_head (work_id, user_id)
