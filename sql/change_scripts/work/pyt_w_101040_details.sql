DROP TABLE IF EXISTS pyt_w_101040_details;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_101040_details(
...
,	PTNNM						varchar(100)		DEFAULT NULL						COMMENT '運送会社名称'
,	SYORIYMD					datetime			DEFAULT NULL						COMMENT '処理日時'
,	DATEYMD						date				DEFAULT NULL						COMMENT '出荷日'
...
,	KEY IX_pyt_w_101040_details_fk_head (user_id,process_divide,work_id,NNSICD)
,	KEY IX_pyt_w_101040_details_id (id)
,	CONSTRAINT FK_pyt_w_101040_details_pyt_w_101040_head
		FOREIGN KEY (user_id,process_divide,work_id) REFERENCES pyt_w_101040_head (user_id,process_divide,work_id)
