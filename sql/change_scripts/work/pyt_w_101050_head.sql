DELETE FROM pyt_w_101050_head;
SET FOREIGN_KEY_CHECKS = 0;
DROP TABLE IF EXISTS pyt_w_101050_head;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_101050_head(
...
,	KEY IX_pyt_w_101050_head_user_id_process_divide (user_id,process_divide)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='仮出荷物量把握一時テーブル';//
