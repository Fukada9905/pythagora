DROP TABLE IF EXISTS pyt_w_104000_details;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_104000_details(
...
,	KEY IX_pyt_w_104000_details_work_id (user_id,process_divide,work_id)
,	CONSTRAINT FK_pyt_w_104000_details_pyt_w_104000_head
		FOREIGN KEY (user_id,process_divide,work_id) REFERENCES pyt_w_104000_head (user_id,process_divide,work_id)
		ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='納品書一覧一時テーブル明細';//
