...
DROP TABLE IF EXISTS pyt_w_103020_details;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_103020_details(
...
,	KEY IX_pyt_w_103020_details_work_id (work_id)
,	CONSTRAINT FK_pyt_w_103020_details_pyt_w_103020_head
		FOREIGN KEY (work_id) REFERENCES pyt_w_103020_head (work_id)
