delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_101030_details(
...
,	KEY IX_pyt_w_101030_details_work_id (work_id)
,	CONSTRAINT FK_pyt_w_101030_details_pyt_w_101030_head
		FOREIGN KEY (work_id) REFERENCES pyt_w_101030_head (work_id)
		ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='出荷ダウンロード一時テーブル明細 (出荷ダウンロード一時テーブル(明細))';//
