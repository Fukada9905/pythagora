...
DROP TABLE IF EXISTS pyt_w_105000_head;
delimiter //
/** テーブル作成 **/
CREATE TABLE pyt_w_105000_head(
...
,	KEY IX_pyt_w_105000_head_user_id_process_divide (user_id,process_divide)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='品目別ロット別集計表一時テーブル';//
