DROP PROCEDURE IF EXISTS pyt_p_101030_csv;
delimiter //

CREATE PROCEDURE pyt_p_101030_csv(
...
BEGIN
    ...
    SET @sql_sel = CONCAT(@sql_sel,' FROM pyt_w_101030_details AS WD');
    SET @sql_sel = CONCAT(@sql_sel,' INNER JOIN pyt_w_101030_head AS WK');
