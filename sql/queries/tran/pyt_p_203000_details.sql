DROP PROCEDURE IF EXISTS pyt_p_203000_details;
delimiter //

CREATE PROCEDURE pyt_p_203000_details(
	IN p_ids text
,	IN p_user_id varchar(10)
)
BEGIN
    
    SET @sql_sel = 'SELECT WD.* FROM pyt_w_203000_details AS WD';
    SET @sql_sel = CONCAT(@sql_sel,' INNER JOIN pyt_w_203000_head AS WK');
