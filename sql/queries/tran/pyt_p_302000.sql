DROP PROCEDURE IF EXISTS pyt_p_302000;
delimiter //

CREATE PROCEDURE pyt_p_302000(
...
BEGIN
    ...
    BEGIN
		DELETE FROM pyt_w_302000_head WHERE user_id = p_user_id;
    ...
    */
    ...
    IF EXISTS(SELECT * FROM tmp_details) THEN
        ...
        IF EXISTS(SELECT work_id FROM pyt_w_302000_head WHERE user_id = p_user_id) THEN
			DELETE FROM pyt_w_302000_head WHERE user_id = p_user_id;
        END IF;
		...
		SET @sql_head = 'INSERT INTO pyt_w_302000_head SELECT';
		...
		SET @sql_ins = 'INSERT INTO pyt_w_302000_details SELECT';
