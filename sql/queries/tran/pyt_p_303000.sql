DROP PROCEDURE IF EXISTS pyt_p_303000;
delimiter //

CREATE PROCEDURE pyt_p_303000(
...
BEGIN
    ...
    BEGIN
		DELETE FROM pyt_w_303000_head WHERE user_id = p_user_id;
    ...
    IF p_is_partner = 1 OR p_is_partner_only = 1 THEN
        ...
        IF p_management_cd IS NOT NULL THEN
    ...
    */
    ...
    IF EXISTS(SELECT * FROM tmp_details) THEN
        ...
        IF EXISTS(SELECT work_id FROM pyt_w_303000_head WHERE user_id = p_user_id) THEN
			DELETE FROM pyt_w_303000_head WHERE user_id = p_user_id;
        END IF;
		...
		SET @sql_head = 'INSERT INTO pyt_w_303000_head SELECT';
		...
		SET @sql_ins = 'INSERT INTO pyt_w_303000_details SELECT';
        ...
        ,	WK.Status
        FROM pyt_w_303000_head AS WK
        INNER JOIN pyt_w_303000_details AS WD
