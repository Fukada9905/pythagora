DROP PROCEDURE IF EXISTS pyt_p_303000_details;
delimiter //

CREATE PROCEDURE pyt_p_303000_details(
	IN p_work_id int
...
BEGIN
    ...
    ,	CONCAT(WD.ReportCorpName,'　|　',WD.Reporter,'　|　',pyt_ufn_get_date_format(ReportDatetime)) AS Reporter
    ,	CONCAT('大塚倉庫 ',WK.JGSNM,'　|　',WD.ReviewerName,'　|　',pyt_ufn_get_date_format(ReviewDatetime)) AS Reviewer
