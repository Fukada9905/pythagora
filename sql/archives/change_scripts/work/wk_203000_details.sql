delimiter //
/** テーブル作成 **/
CREATE TABLE wk_203000_details(
...
,	KEY IX_wk_203000_details_work_id (work_id)
,	KEY IX_wk_203000_details_arrival_schedule_details (ID,DENGNO,NIBKNRDENGNO,SHCD,JGSCD_SK,SNTCD_SK,RTNO,LOTK,LOTS,FCKBNKK)
,	CONSTRAINT FK_wk_203000_details_wk_203000_head
		FOREIGN KEY (work_id) REFERENCES wk_203000_head (work_id)
		ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='検品報告一時テーブル明細 (検品報告一時テーブル(明細))';//
