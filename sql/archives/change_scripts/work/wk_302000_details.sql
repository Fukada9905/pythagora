delimiter //
/** テーブル作成 **/
CREATE TABLE wk_302000_details(
...
,	KEY IX_wk_302000_details_work_id (work_id)
,	KEY IX_wk_302000_details_location_stocks (DET_ID)
,	CONSTRAINT FK_wk_302000_details_wk_302000_head
		FOREIGN KEY (work_id) REFERENCES wk_302000_head (work_id)
