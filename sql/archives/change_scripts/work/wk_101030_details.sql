delimiter //
/** テーブル作成 **/
CREATE TABLE wk_101030_details(
...
,	KEY IX_wk_101030_details_work_id (work_id)
,	CONSTRAINT FK_wk_101030_details_wk_101030_head
		FOREIGN KEY (work_id) REFERENCES wk_101030_head (work_id)
