DROP PROCEDURE IF EXISTS usp_101030_csv;
delimiter //

CREATE PROCEDURE usp_101030_csv(
...
BEGIN
	...
	SET @sql_sel = CONCAT(@sql_sel, ' , WD.WGT AS \'総重量\'');
    ...
    SET @sql_sel = CONCAT(@sql_sel,' FROM wk_101030_details AS WD');
    SET @sql_sel = CONCAT(@sql_sel,' INNER JOIN wk_101030_head AS WK');
