...
class pg_101043_index extends page_front
{
    private $_selections;
	...
	protected function view(){
		...
		$_SESSION["101043_NNSI_HEADER"] = serialize($nnsi_header);
		...
		$_SESSION["101043_SEARCH_HEADER"] = serialize($search_array);
	}
	protected function render(){
		...
		$this->template->render(TEMPLATE_DIR. DS . '101/043.tpl.php');
	}
}

$page = new pg_101043_index();
$page->run();